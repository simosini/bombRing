...
public class BombExplodedMessage extends Message {
	...
	public boolean handleInMessage(ConnectionData clientConnection) {
		try {
			...
			String myColorZone = peer.getCurrentPosition().getColorZone();
			String bombColor = this.getColor();

			// check position 
			if (peer.isAlive() && bombColor.equalsIgnoreCase(myColorZone)) { //if bomb killed me
